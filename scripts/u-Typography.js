...
function BiaoDianBuHuan(){
	...
	// document.body.querySelectorAll("article .PoZheHao h-char h-inner, article .YiZiXian, article .BanZiXian, article .FenGeHao h-char h-inner, article .JianGeHao h-char h-inner").forEach((e) => {
